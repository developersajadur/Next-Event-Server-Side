...
const createParticipant = async (payload: any) => {
    ...
    if (isAlreadyParticipated) {
        throw new AppError(status.BAD_REQUEST, "You have already participated in this event")
    }
...
const getAllParticipants = async (query: Record<string, any>, options: IPaginationOptions) => {
...
const updateParticipantStatus = async (participantId: string, status: ParticipationStatus) => {
