...
const auth = (...roles) => {
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const verifiedUser = (yield jwtHelpers_1.jwtHelpers.verifyToken(token, config_1.default.jwt.ACCESS_TOKEN_SECRET));
            ...
            if (isUserExist.isDeleted) {
                throw new AppError_1.default(http_status_1.default.FORBIDDEN, 'You are deleted!');
            }
