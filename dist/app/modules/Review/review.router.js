...
router.get('/:id', (0, Auth_1.default)('USER', 'ADMIN'), review_controller_1.ReviewController.getMyReviews);
...
router.get('/my-review/:id', (0, Auth_1.default)('ADMIN', 'USER'), review_controller_1.ReviewController.myAllReviews);
router.get('/events/:id', review_controller_1.ReviewController.getReviewsByEvent);
