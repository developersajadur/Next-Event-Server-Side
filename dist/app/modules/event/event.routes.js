...
router.get('/slug/:slug', (0, Auth_1.default)(client_1.Role.ADMIN, client_1.Role.USER), event_controller_1.EventController.getSingleEventBySlug);
...
router.patch('/update/:id', (0, Auth_1.default)(client_1.Role.ADMIN, client_1.Role.USER), fileUploader_1.fileUploads.upload.single('file'), (req, res, next) => {
    const parsedData = JSON.parse(req.body.data);
