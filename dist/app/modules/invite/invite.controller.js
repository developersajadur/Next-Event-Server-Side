...
const rejectInvite = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { inviteId } = req.params;
    const result = yield invite_service_1.InviteService.RejectInvite(inviteId);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
